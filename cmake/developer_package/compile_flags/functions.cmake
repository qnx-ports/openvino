...
macro(ov_sse42_optimization_flags flags)
    ...
    elseif(OV_COMPILER_IS_CLANG OR CMAKE_COMPILER_IS_GNUCXX OR (CMAKE_CXX_COMPILER_ID STREQUAL "QCC"))
        set(${flags} -msse4.2)
        if(EMSCRIPTEN)
...
macro(ov_avx512_optimization_flags flags)
    ...
    elseif(OV_COMPILER_IS_CLANG OR CMAKE_COMPILER_IS_GNUCXX OR (CMAKE_CXX_COMPILER_ID STREQUAL "QCC") OR (OV_COMPILER_IS_INTEL_LLVM AND UNIX))
