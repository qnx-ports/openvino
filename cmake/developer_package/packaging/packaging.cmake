...
# Default install directories for standard generic builds (no CPack generator or unknown)
if(NOT DEFINED OV_CPACK_LIBRARYDIR)
    include(GNUInstallDirs)
    set(OV_CPACK_INCLUDEDIR ${CMAKE_INSTALL_INCLUDEDIR})
    set(OV_CPACK_OPENVINO_CMAKEDIR ${CMAKE_INSTALL_LIBDIR}/cmake/openvino)
    set(OV_CPACK_DOCDIR ${CMAKE_INSTALL_DATADIR}/doc/openvino)
    set(OV_CPACK_LICENSESDIR ${CMAKE_INSTALL_DATADIR}/licenses/openvino)
    set(OV_CPACK_SAMPLESDIR ${CMAKE_INSTALL_DATADIR}/openvino/samples)
    set(OV_CPACK_WHEELSDIR ${CMAKE_INSTALL_DATADIR}/openvino/wheels)
    set(OV_CPACK_DEVREQDIR ${CMAKE_INSTALL_DATADIR}/openvino/tools)
    set(OV_CPACK_PYTHONDIR ${CMAKE_INSTALL_LIBDIR}/python/site-packages)
